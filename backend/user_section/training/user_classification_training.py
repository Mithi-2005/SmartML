...
class UserClassificationTrainer:
    ...
    def __init__(
        ...
        if azure_blob_helper.enabled:
            ...
            self.metadata_dir = Path(self.temp_dir.name)
        else:
    ...
    def train_and_tune_model(self, Tuning=False):
        ...
        from utils.azure_blob import azure_blob_helper
        if azure_blob_helper.enabled:
            save_path = str(Path(self.temp_dir.name) / f"{self.dataset_name}.pkl")
        else:
        ...
        try:
            ...
            if hasattr(self, "temp_dir") and self.temp_dir:
                try:
                    ...
                    print(f"Warning: Failed to cleanup trainer temp dir: {cleanup_err}")
